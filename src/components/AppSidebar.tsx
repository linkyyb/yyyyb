...
export default function AppSidebar({
  ...
  return (
    <div className="w-[300px] bg-[var(--bg-sidebar)] border-r border-[var(--border)] flex flex-col h-full shadow-sm shrink-0">
      ...
      <div className="flex bg-slate-50 p-2 gap-1 border-b border-slate-100 shrink-0">
        ...
        {activeTab === 'exams' && (
          <div className="space-y-4">
            <div className="flex justify-between items-center px-1 mb-2">
              ...
              <button onClick={() => setIsUploadModalOpen(true)} className="text-[10px] bg-slate-100 hover:bg-slate-200 text-slate-600 font-bold px-2 py-0.5 rounded flex items-center gap-1">
            ...
            {[...exams].sort((a, b) => b.year.localeCompare(a.year)).map((exam) => {
              ...
              return (
                <div key={exam.id} className="border border-slate-200 rounded-xl overflow-hidden group">
                            ...
                            return (
                              <button
                                ...
                                className={`w-full text-left p-2.5 rounded-lg flex items-center justify-between transition-colors border ${
                                  isActive ? 'bg-blue-50 border-blue-200 text-blue-700 font-bold shadow-sm' : 'bg-white border-transparent text-slate-600 hover:bg-slate-50'
                                }`}
                              >
