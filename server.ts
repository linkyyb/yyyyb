...
Output ONLY JSON: {"title":"长篇阅读","section":"long-reading-match","paragraphs":[{"id":"p1","sentences":["[A] The first sentence of paragraph A.","The second sentence."]}],"questions":[{"id":"q36","number":36,"questionType":"long-reading-match","content":"statement","matchParagraph":"D","correctAnswer":"D","options":[],"answerExplanation":"中文解析"}]}`;
